...
select customer_id,max(purchase_amount) as "MaximumPurchaseAmount" from order group by customer_id;

select customer_id,max(purchase_amount) as "MaximumPurchaseAmount" from orders group by customer_id;
