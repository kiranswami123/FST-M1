...
INSERT INTO salesman VALUES(5002, 'ABC', 'New York', 13);
...
SELECT grade, COUNT(*) FROM customers where 1=1;
...
SELECT grade, customer_name FROM customers;
...
SELECT grade, COUNT(*) FROM customers 
GROUP BY grade where grade>(SELECT AVG(grade) FROM customers WHERE city='New York');
